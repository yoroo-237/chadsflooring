...
const NAV_ITEMS = [
  ...
  { label: 'Credits',   path: '/wallet',   icon: <CreditIcon /> },
  { label: 'Orders',    path: '/orders',   icon: <OrdersIcon /> },
  { label: 'Your Team', path: '/team',     icon: <TeamIcon /> },
  ...
  return (
    <aside className="account-sidebar">
      <div className="account-sidebar-top">
        <span className="account-sidebar-title">Manage Account</span>
        <span className="account-sidebar-greeting">Hey, {username.split(' ')[0]}</span>
      </div>
